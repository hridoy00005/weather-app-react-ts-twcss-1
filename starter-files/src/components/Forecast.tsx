...
function Forecast({ data }: Props): JSX.Element {
  ...
  return (
    <div className="w-full md:max-w-[500px] h-full lg:h-auto py-4 md:py-4 md:px-10 lg:px-24 bg-white bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg md:my-10">
